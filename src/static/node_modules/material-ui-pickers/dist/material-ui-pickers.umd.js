(function (global, factory) {
    ...
    (factory((global['material-ui-pickers'] = {}),global.PropTypes,global.React,global.Icon,global.IconButton,global.InputAdornment,global.TextField,global.Button,global.Dialog,global.DialogActions,global.DialogContent,global.withStyles,global.createStyles,global.Toolbar,global.Typography,global.ReactDOM,global.Popover,global.Paper,global.withTheme,global.Tab,global.Tabs));
    ...
    ***************************************************************************** */
    ...
    var Input = /** @class */ (function (_super) {
        ...
        Input.prototype.render = function () {
            ...
            return this.props.mask ? (React.createElement(MaskedInput, __assign({}, rest, { ref: inputRef }))) : (React.createElement("input", __assign({}, rest, { ref: inputRef })));
        };
        Input.propTypes = {
            mask: PropTypes.any,
    ...
    */
    ...
    var ModalWrapper = /** @class */ (function (_super) {
        ...
        ModalWrapper.prototype.render = function () {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(DateTextField$1, __assign({ value: value, format: format, onClick: this.open, 
                ...
                React.createElement(ModalDialog$1, __assign({ open: this.state.open, onKeyDown: this.handleKeyDown, onClear: this.handleClear, onAccept: this.handleAccept, onDismiss: this.handleDismiss, onSetToday: this.handleSetTodayDate, dialogContentClassName: dialogContentClassName, clearLabel: clearLabel, todayLabel: todayLabel, okLabel: okLabel, cancelLabel: cancelLabel, clearable: clearable, showTodayButton: showTodayButton, children: children }, DialogProps))));
        };
    ...
    var SlideTransition = function (_a) {
        ...
        return (React.createElement(reactTransitionGroup_2, { className: classnames(classes.transitionContainer, className) },
            React.createElement(reactTransitionGroup_4, { key: transKey, mountOnEnter: true, unmountOnExit: true, timeout: animationDuration, children: children, classNames: {
    ...
    var DatePickerModal$1 = React.forwardRef(function (props, ref) { return (React.createElement(DatePickerModal, __assign({}, props, { forwardedRef: ref }))); });
    ...
    var InlineWrapper = /** @class */ (function (_super) {
        ...
        InlineWrapper.prototype.render = function () {
            ...
            return (React.createElement(React.Fragment, null,
                ...
                React.createElement(DateTextField$1, __assign({ value: value, format: format, onClick: this.open, keyboard: keyboard }, other)),
    ...
    var DatePickerInline = function (props) {
        ...
        return (React.createElement(BasePicker$1, __assign({}, props, { autoOk: true }), function (_a) {
            ...
            return (React.createElement(InlineWrapper$1, __assign({ disableFuture: disableFuture, disablePast: disablePast, format: format || utils.dateFormat, labelFunc: labelFunc, maxDate: maxDate, minDate: minDate, onChange: handleTextFieldChange, innerRef: forwardedRef, value: value, isAccepted: isAccepted, handleAccept: handleAccept }, other),
    ...
    var DatePickerInline$1 = React.forwardRef(function (props, ref) { return (React.createElement(DatePickerInline, __assign({}, props, { forwardedRef: ref }))); });
    ...
    var getHourNumbers = function (_a) {
        ...
        for (var hour = startHour; hour <= endHour; hour += 1) {
            ...
            hourNumbers.push(React.createElement(ClockNumber$1, __assign({ key: hour }, props)));
        }
        return hourNumbers;
    };
    ...
    var TimePickerView = /** @class */ (function (_super) {
        ...
        TimePickerView.prototype.render = function () {
            ...
            return React.createElement(Clock$1, __assign({ type: type, ampm: ampm }, viewProps));
        };
    ...
    var TimePickerModal$1 = React.forwardRef(function (props, ref) { return (React.createElement(TimePickerModal, __assign({}, props, { forwardedRef: ref }))); });
    ...
    var TimePickerInline = function (props) {
        ...
        return (React.createElement(BasePicker$1, __assign({}, props, { autoOk: true }), function (_a) {
            ...
            return (React.createElement(InlineWrapper$1, __assign({ innerRef: forwardedRef, value: value, onChange: handleTextFieldChange, isAccepted: isAccepted, handleAccept: handleAccept, format: pick12hOr24hFormat(utils.time12hFormat, utils.time24hFormat) }, other),
                React.createElement(TimePicker$1, { date: date, onChange: handleChange, ampm: ampm, seconds: seconds })));
        }));
    };
    ...
    var TimePickerInline$1 = React.forwardRef(function (props, ref) { return (React.createElement(TimePickerInline, __assign({}, props, { forwardedRef: ref }))); });
    ...
    var DateTimePickerModal$1 = React.forwardRef(function (props, ref) { return (React.createElement(DateTimePickerModal, __assign({}, props, { forwardedRef: ref }))); });

    var DateTimePickerInline = function (props) {
        var value = props.value, format = props.format, autoOk = props.autoOk, openTo = props.openTo, minDate = props.minDate, maxDate = props.maxDate, initialFocusedDate = props.initialFocusedDate, showTabs = props.showTabs, autoSubmit = props.autoSubmit, disablePast = props.disablePast, disableFuture = props.disableFuture, leftArrowIcon = props.leftArrowIcon, rightArrowIcon = props.rightArrowIcon, dateRangeIcon = props.dateRangeIcon, timeIcon = props.timeIcon, renderDay = props.renderDay, ampm = props.ampm, shouldDisableDate = props.shouldDisableDate, animateYearScrolling = props.animateYearScrolling, forwardedRef = props.forwardedRef, allowKeyboardControl = props.allowKeyboardControl, other = __rest(props, ["value", "format", "autoOk", "openTo", "minDate", "maxDate", "initialFocusedDate", "showTabs", "autoSubmit", "disablePast", "disableFuture", "leftArrowIcon", "rightArrowIcon", "dateRangeIcon", "timeIcon", "renderDay", "ampm", "shouldDisableDate", "animateYearScrolling", "forwardedRef", "allowKeyboardControl"]);
        return (React.createElement(BasePicker$1, __assign({}, props, { autoOk: true }), function (_a) {
            var date = _a.date, utils = _a.utils, handleChange = _a.handleChange, handleTextFieldChange = _a.handleTextFieldChange, isAccepted = _a.isAccepted, pick12hOr24hFormat = _a.pick12hOr24hFormat, handleAccept = _a.handleAccept;
            return (React.createElement(InlineWrapper$1, __assign({ innerRef: forwardedRef, disableFuture: disableFuture, disablePast: disablePast, maxDate: maxDate, minDate: minDate, onChange: handleTextFieldChange, value: value, isAccepted: isAccepted, handleAccept: handleAccept, format: pick12hOr24hFormat(utils.dateTime12hFormat, utils.dateTime24hFormat) }, other),
                React.createElement(DateTimePicker$1, { allowKeyboardControl: allowKeyboardControl, ampm: ampm, animateYearScrolling: animateYearScrolling, autoSubmit: autoSubmit, date: date, dateRangeIcon: dateRangeIcon, disableFuture: disableFuture, disablePast: disablePast, leftArrowIcon: leftArrowIcon, maxDate: maxDate, minDate: minDate, onChange: handleChange, openTo: openTo, renderDay: renderDay, rightArrowIcon: rightArrowIcon, shouldDisableDate: shouldDisableDate, showTabs: showTabs, timeIcon: timeIcon })));
        }));
    };
    ...
    var DateTimePickerInline$1 = React.forwardRef(function (props, ref) { return (React.createElement(DateTimePickerInline, __assign({}, props, { forwardedRef: ref }))); });
